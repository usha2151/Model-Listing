                          ...
                          <div className="py-12">
                              ...
                              <div className="relative h-11 w-full min-w-[200px]">
                                ...
                                onChange={(e) => setEmail(e.target.value)}
                                  className="peer h-full  w-full border-b-2 border-gray bg-transparent pt-4 pb-1.5 font-sans text-sm font-normal text-blue-gray outline outline-0 transition-all placeholder-shown:border-blue-gray-200 focus:border-pink-500 focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                                  placeholder=" "
                                />
                              ...
                              <div className="relative h-11 mt-10 w-full min-w-[200px]">
                                <input
                                 type="password"
                                 value={password}
