...
const Filtermodelsdata = () => {
  const allSpecializations = ["All", "Fashion", "Fitness", "Promotional"];
            ...
            <div className="md:col-span-8 col-span-12">
              <div className="grid md:grid-cols-2 grid-cols-1 gap-60">
                <div>
                  ...
                  <p className="text-white">Showing {filteredUsers.length} results</p>
                </div>

                <div className="flex items-center text-h6">
                  <span className="bg-purple text-white py-[3.88%] px-6">Sort by:</span>
                  <select
                    id="inputState"
                ...
                {filteredUsers.map((userData, index) => (
                  <div key={index} className="relative">
                    ...
                    <div className="absolute bottom-10 left-10 right-0 text-white py-4 px-2">
                      <p className="text-h3 w-20 font-semibold leading-8">{userData.name}</p>
              ...
              <div className="flex justify-center items-center ml-auto mt-7" style={{ marginTop: "10px" }}>
